...
#            response = request.doException(merror.SlaveFailure)
        if request.unit_id == 1:
            response = request.doException(merror.IllegalFunction)
        elif request.unit_id == 2:
            response = request.doException(merror.IllegalAddress)
        elif request.unit_id == 3:
            response = request.doException(merror.IllegalValue)
        elif request.unit_id == 4:
            response = request.doException(merror.SlaveFailure)
        elif request.unit_id == 5:
            response = request.doException(merror.Acknowledge)
        elif request.unit_id == 6:
